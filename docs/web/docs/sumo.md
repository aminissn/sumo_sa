...
| **--device.toc.explicit** {{DT_STR_LIST}} | Assign a 'toc' device to named vehicles |
...
| **--device.driverstate.explicit** {{DT_STR_LIST}} | Assign a 'driverstate' device to named vehicles |
...
| **--device.bluelight.explicit** {{DT_STR_LIST}} | Assign a 'bluelight' device to named vehicles |
...
| **--device.fcd.explicit** {{DT_STR_LIST}} | Assign a 'fcd' device to named vehicles |
...
| **--person-device.fcd.explicit** {{DT_STR_LIST}} | Assign a 'fcd' device to named persons |
